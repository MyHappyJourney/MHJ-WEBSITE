...
export const Hero: React.FC<HeroProps> = ({ onQuoteClick, preselectedPackageId }) => {
  ...
  const whatsappMsg = encodeURIComponent(
    `Hi MyHappyJourney, I am interested in a customized Kerala Tour Package for Senior Citizens. Name: ${formData.name || 'Traveler'}, Package: ${selectedPkg.title} (${selectedPkg.durationBadge}), Travel Date: ${formData.travelDate || 'Upcoming'}, Guests: ${formData.adults} Adults. Please share senior-friendly itinerary & best quote.`
  );
    ...
    <section id="hero-section" className="relative bg-slate-900 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Kerala Houseboat Backwaters Alleppey for Senior Citizens"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-6 space-y-4 sm:space-y-6 text-left lg:pt-2">
            ...
            <div className="inline-flex items-center gap-2 bg-[#0B3996]/90 backdrop-blur-md text-white text-xs sm:text-sm font-extrabold px-3.5 py-1.5 rounded-full border border-blue-400/30 shadow-md">
              ...
              <span>DESIGNED FOR SENIOR CITIZENS • ZERO-RUSH & ACCESSIBLE</span>
            </div>
            ...
            <div>
              <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black tracking-tight leading-tight text-white drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)]">
                ...
                <span className="text-amber-300">for Senior Citizens</span>
              </h1>
              <p className="text-sm sm:text-base text-gray-200 mt-2 font-medium leading-relaxed">
                Experience God's Own Country with effortless comfort. Relaxed pacing, lift-accessible stays, courteous chauffeurs assisting with luggage, mild home-style food, and 24/7 senior care.
              </p>
            </div>
            ...
            <div className="pt-1">
              <p className="text-xs text-gray-300 font-bold mb-2 uppercase tracking-wider flex items-center gap-1.5">
                ...
                <span>Popular Senior-Friendly Destinations:</span>
              </p>
              <div className="grid grid-cols-2 sm:flex sm:flex-wrap gap-2 text-xs sm:text-sm font-semibold">
                <div className="flex items-center gap-1.5 bg-black/50 backdrop-blur-md border border-white/20 px-3 py-1.5 rounded-xl text-gray-100 shadow-sm">
                  ...
                  <span>2N Munnar (Gentle Hills)</span>
                </div>
                <div className="flex items-center gap-1.5 bg-black/50 backdrop-blur-md border border-white/20 px-3 py-1.5 rounded-xl text-gray-100 shadow-sm">
                  <MapPin className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                  <span>1N Thekkady (Lake Wildlife)</span>
                </div>
                <div className="flex items-center gap-1.5 bg-black/50 backdrop-blur-md border border-white/20 px-3 py-1.5 rounded-xl text-gray-100 shadow-sm">
                  <MapPin className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                  <span>1N Alleppey (Tranquil Houseboat)</span>
                </div>
                <div className="flex items-center gap-1.5 bg-black/50 backdrop-blur-md border border-white/20 px-3 py-1.5 rounded-xl text-gray-100 shadow-sm">
                  <MapPin className="w-3.5 h-3.5 text-amber-400 shrink-0" />
                  <span>2N Kovalam (Temple & Beach)</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-black/45 backdrop-blur-md border border-white/15 rounded-2xl p-4 sm:p-5 text-gray-100 space-y-2.5 shadow-xl">
              <p className="text-xs font-extrabold uppercase tracking-wider text-amber-400">Senior Comfort Package Inclusions:</p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs sm:text-sm font-medium">
                <div className="flex items-center gap-2">
                  ...
                  <span>Lift-Access 3★/4★ Stays & Ground Rooms</span>
                </div>
                <div className="flex items-center gap-2">
                  <Car className="w-4 h-4 text-[#FF4B00] shrink-0" />
                  <span>Private AC Cab & Senior-Care Chauffeur</span>
                </div>
                <div className="flex items-center gap-2">
                  <Utensils className="w-4 h-4 text-[#FF4B00] shrink-0" />
                  <span>Mild, Custom Meals & Daily Breakfast</span>
                </div>
                <div className="flex items-center gap-2">
                  <Sparkles className="w-4 h-4 text-[#FF4B00] shrink-0" />
                  <span>Easy-Board Deluxe Houseboat + All Meals</span>
                </div>
              </div>
            </div>
