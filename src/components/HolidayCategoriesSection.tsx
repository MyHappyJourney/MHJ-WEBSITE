...
export const HolidayCategoriesSection: React.FC<HolidayCategoriesSectionProps> = ({
  ...
  const categories: HolidayCategory[] = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1539635278303-d4002c07eae3?auto=format&fit=crop&w=1200&q=85',
    },
    {
      id: 'luxury',
      title: 'Bespoke Luxury & Heritage',
      subtitle: 'Palaces, 5-star villas & private transfers',
