        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 pb-10 border-b border-gray-800">
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              MyHappyJourney is a premier Kerala tour operator with 18+ years of expertise in delivering comfortable, zero-rush senior citizen tours, accessible vacations, and serene backwater cruises.
            </p>
