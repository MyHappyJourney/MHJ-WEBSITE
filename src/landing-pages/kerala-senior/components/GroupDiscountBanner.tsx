...
export const GroupDiscountBanner: React.FC = () => {
    ...
    >
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <p className="max-w-2xl mx-auto text-sm sm:text-base md:text-lg text-white font-medium leading-relaxed mb-8 sm:mb-9 drop-shadow-[0_2px_8px_rgba(0,0,0,0.85)]">
          Planning for senior citizen groups, community clubs, or family reunions of 10+ people? We provide dedicated helpers, accessible transport, and unbeatable group rates!
        </p>
