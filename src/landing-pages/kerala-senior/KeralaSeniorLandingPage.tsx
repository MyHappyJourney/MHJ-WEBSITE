...
interface KeralaSeniorLandingPageProps {
  onBackToHome?: () => void;
}

export const KeralaSeniorLandingPage: React.FC<KeralaSeniorLandingPageProps> = ({ onBackToHome }) => {
...
export default KeralaSeniorLandingPage;
